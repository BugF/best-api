...
> [!NOTE]
> 本项目为开源项目，在[One API](https://github.com/songquanpeng/one-api)及[One API]([https://github.com/songquanpeng/one-api](https://github.com/Calcium-Ion/new-api))的基础上进行二次开发
